...
import com.jingna.shopapp.fragment.FragmentFocusGoods;
import com.jingna.shopapp.fragment.FragmentFocusShop;
...
public class FocusActivity extends BaseActivity {
    ...
    private Context context = FocusActivity.this;
    ...
    private void initData() {
        ...
        fragmentList.add(new FragmentFocusGoods());
        fragmentList.add(new FragmentFocusShop());
...
//                simplePagerTitleView.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
            ...
            public IPagerIndicator getIndicator(Context context) {
                ...
                indicator.setColors(Color.parseColor("#FF0004"));
                return indicator;
            }
        });
