...
public class FragmentExpiredCouponsAdapter extends RecyclerView.Adapter<FragmentExpiredCouponsAdapter.ViewHolder> {

    private Context context;
    private List<AppCouponBean.DataBean> data;

    public FragmentExpiredCouponsAdapter(List<AppCouponBean.DataBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_expired_coupons, parent, false);
