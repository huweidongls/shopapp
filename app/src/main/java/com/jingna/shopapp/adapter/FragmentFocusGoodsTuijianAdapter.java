...
public class FragmentFocusGoodsTuijianAdapter extends RecyclerView.Adapter<FragmentFocusGoodsTuijianAdapter.ViewHolder> {

    private Context context;
    private List<IndexGoodsBean.DataBean> data;

    public FragmentFocusGoodsTuijianAdapter(List<IndexGoodsBean.DataBean> data) {
        this.data = data;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recyclerview_fragment_focus_tuijian, parent, false);
