...
public class EditPhoneNumTimeCount extends CountDownTimer {

    private SpannableString msp = null;
    private int timeNum = 60;
    private EditPhoneNum1Activity activity;
    ...
    public EditPhoneNum1Activity getActivity() {
        return activity;
    }

    public void setActivity(EditPhoneNum1Activity activity) {
        this.activity = activity;
    }

    public EditPhoneNumTimeCount(long millisInFuture, long countDownInterval) {
