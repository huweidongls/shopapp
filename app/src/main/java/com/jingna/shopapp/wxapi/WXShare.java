...
import com.jingna.shopapp.util.ImageUtils;
...
public class WXShare {
    ...
    public static final String APP_ID = "wx84adae87b2b30943";
...
//        Logger.i("text shared: " + result);
    ...
    public void shareUrl(final String url, final String title, final String subtitle, final String pic) {
        ...
        imageUtils.getImage(Const.BASE_URL + pic, new HttpCallBackListener() {
            @Override
